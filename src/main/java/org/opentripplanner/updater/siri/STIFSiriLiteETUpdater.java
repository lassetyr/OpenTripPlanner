 ...
 *
 * <pre>
 * rt.type = stif-siri-lite-et-updater
 * rt.frequencySec = 60
 ...
 *
 */
public class STIFSiriLiteETUpdater extends SiriETUpdater {

    private static final Logger LOG = LoggerFactory.getLogger(STIFSiriLiteETUpdater.class);
    ...
    public void configurePolling(Graph graph, JsonNode config) throws Exception {
        ...
        updateSource = new STIFSiriLiteETHttpTripUpdateSource();
